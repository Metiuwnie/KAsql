...
<div class="main-content">
    ...
    <div class="container">
        ...
        <div class="card">
            <h3 style="margin-bottom: 15px;">Analisis Data Jurnal dengan AI</h3>
            ...
            <form method="POST" action="" id="analyzeForm" onsubmit="document.getElementById('loadingOverlay').style.display='flex';">
                ...
                <div class="ai-status-bar">
                    <div class="ai-status-info">
                        ...
                        <span class="ai-status-desc">
                            <?= !empty($_SESSION['api_key']) ? 'Model: ' . htmlspecialchars($_SESSION['model_choice'] ?? 'gemini-3.5-flash-lite') : 'Audit kepatuhan entri jurnal. Hubungkan Gemini API Key untuk audit mendalam.' ?>
                        </span>
                    </div>
                ...
                <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 8px;">
                    <button type="submit" name="analyze" class="btn btn-gemini">
                        ...
                        Jalankan Audit & Analisis Jurnal Cerdas
                    </button>

                    <div class="ai-disclaimer-note">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                        <span>Hasil audit & analisis ini ditujukan sebagai rekomendasi pengendalian internal.</span>
                    </div>
                </div>
            </form>
        </div>
